...
class lanCraftScan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scan:lanCraft';
    ...
    public function handle(){
        ...
        echo "Input the filtering rule of lanCrafts' name [Use '|' to division] default: .rar|+|.zip|.7z|.exe: ";
        ...
        for ($i = 2; $i < count($dir); $i++){
            ...
            // mysql
            $check = DB::table("lanCraft")->where("name", $tools_name)->get();
        ...
        echo "\nFinish the lanCrafts import. Time used: ".round(microtime(true) - $start,4)."ms\n\n";
