...
class LanCraft extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create("lanCraft",function (Blueprint $table){
        ...
        DB::statement("ALTER TABLE lanCraft AUTO_INCREMENT = 10000;");
    }
