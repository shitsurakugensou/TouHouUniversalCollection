                    ...
                    <div class="page-footer-contant mdui-valign">
                        <div class="mdui-valign mdui-typo">
                            ...
                            @if(env("APP_DEBUG") == false)
                                <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? "https://" : "http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1277106802'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s5.cnzz.com/z_stat.php%3Fid%3D1277106802%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
                            @endif
                        </div>
                    </div>
                </div>
